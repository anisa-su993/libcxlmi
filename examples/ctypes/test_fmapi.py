...
3. Send FMAPI commands
4. Display the results

This version uses the ctypes bindings from bindings.py instead of SWIG.
"""
...
def send_fmapi_commands(ep):
    try:
        ...
        rsp = struct_cxlmi_cmd_fmapi_get_dc_region_ext_list_rsp()
        ...
        # Note: In ctypes we don't need FMAPIDCExtentArray, the array is part of the structure
